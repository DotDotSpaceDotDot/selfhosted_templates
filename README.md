...
3. Add the url: `https://raw.githubusercontent.com/SelfhostedPro/selfhosted_templates/portainer-2.0/Template/template.json` then go to app templates and hit refresh at the top.
