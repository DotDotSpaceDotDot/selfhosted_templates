# Portainer 2 Templates for Selfhosted Projects/Homelabs
...
3. Add the url: `https://raw.githubusercontent.com/DotDotSpaceDotDot/selfhosted_templates/portainer-2.0/Template/template.json` then go to app templates and hit refresh at the top.
